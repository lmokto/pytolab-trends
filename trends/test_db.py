...
class DbTest(unittest.TestCase):
    ...
    def setUp(self):
        self.db = db.Db()
        self.cfg_mysql_host = 'localhost'
        self.cfg_mysql_user = 'monty'
        self.cfg_mysql_password = 'some_pass'
        self.cfg_mysql_db = 'test_mysql_db'
        self.cfg_twitter_userid = 'unem_gentleman'
        self.cfg_twitter_password = 'hacura'
        self.cfg_redis_host = 'localhost'
        self.cfg_redis_port = 6379
        self.cfg_rabbitmq_host = 'localhost'
        self.cfg_rabbitmq_userid = 'luis'
        self.cfg_rabbitmq_password = '123'
    ...
    def test_setup_mysql_connect_error(self, connect_mock):
        ...
        self.assertRaises(ex.DbError, self.db.setup_mysql)
    ...
    def test_setup_mysql_loop_db_error(self, time_sleep_mock, setup_mysql_mock):
        ...
        setup_mysql_mock.side_effect = ex.DbError() 
        self.assertRaises(ex.DbError, self.db.setup_mysql_loop) 
    ...
    def test_mysql_command_operational_error(self, db_cursor_mock,
        ...
        setup_mysql_loop_mock.side_effect = ex.DbError()
        self.assertRaises(ex.DbError,
